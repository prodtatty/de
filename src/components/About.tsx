...
const FACTS = [
  ...
  { value: 'ПНД', label: 'материал корпуса' },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Reveal delay={160} className="mt-6 max-w-3xl space-y-4">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-white/70">
            ...
            списывать лодку целиком. Каждая модель линейки сертифицирована по техническому регламенту
